...
This DE indicates the components of an [**PerceivedObject**](ETSI-ITS-CDD.md#PerceivedObject) that are included in the [**LowerTriangularPositiveSemidefiniteMatrix**](#LowerTriangularPositiveSemidefiniteMatrix).
...
* _clusterId_ of type [**Identifier1B**](ETSI-ITS-CDD.md#Identifier1B) <br>
...
* _interferenceManagementZoneShape_ of type [**Shape**](ETSI-ITS-CDD.md#Shape)  (WITH COMPONENTS{..., radial ABSENT, radialShapes ABSENT}) OPTIONAL<br>
...
* _expiryTime_ of type [**TimestampIts**](ETSI-ITS-CDD.md#TimestampIts)  OPTIONAL<br>
...
* _region_ of type [**Identifier2B**](ETSI-ITS-CDD.md#Identifier2B)  OPTIONAL<br>
...
* _protocolVersion_ of type [**OrdinalNumber1B**](ETSI-ITS-CDD.md#OrdinalNumber1B) <br>
...
* _componentsIncludedIntheMatrix_ of type [**MatrixIncludedComponents**](#MatrixIncludedComponents) <br>
  the indication of which components of a [**PerceivedObject**](ETSI-ITS-CDD.md#PerceivedObject) are included in the matrix. 
...
* _laneId_ of type [**Identifier1B**](ETSI-ITS-CDD.md#Identifier1B)  OPTIONAL<br>
  optionally identifies the lane in the road segment or intersection topology on which the position is located.

* _connectionId_ of type [**Identifier1B**](ETSI-ITS-CDD.md#Identifier1B)  OPTIONAL<br>
...
* _confidence_ of type [**ConfidenceLevel**](ETSI-ITS-CDD.md#ConfidenceLevel) <br>
* Confidence<br>
...
* _objectId_ of type [**Identifier2B**](ETSI-ITS-CDD.md#Identifier2B)  OPTIONAL<br>
...
* _objectAge_ of type [**DeltaTimeMilliSecondSigned**](ETSI-ITS-CDD.md#DeltaTimeMilliSecondSigned)  (0..2047) OPTIONAL<br>
...
* _refPointId_ of type [**Identifier1B**](ETSI-ITS-CDD.md#Identifier1B) <br>
...
The DF contains a list of DE [**Identifier1B**](ETSI-ITS-CDD.md#Identifier1B).
...
* _clusterId_ of type [**Identifier1B**](ETSI-ITS-CDD.md#Identifier1B)  OPTIONAL<br>
  optional identifier of a VRU cluster .

* _clusterBoundingBoxShape_ of type [**Shape**](ETSI-ITS-CDD.md#Shape)  (WITH COMPONENTS{..., elliptical ABSENT, radial ABSENT, radialShapes ABSENT}) OPTIONAL<br>
  optionally indicates the shape of the cluster bounding box.

* _clusterCardinalitySize_ of type [**CardinalNumber1B**](ETSI-ITS-CDD.md#CardinalNumber1B) <br>
