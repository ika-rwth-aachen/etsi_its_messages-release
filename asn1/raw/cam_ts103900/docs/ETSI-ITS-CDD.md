...
* _zAcceleration_ of type [**AccelerationComponent**](ETSI-ITS-CDD.md#AccelerationComponent)  OPTIONAL<br>
...
* _xAcceleration_ of type [**AccelerationComponent**](ETSI-ITS-CDD.md#AccelerationComponent) <br>
  the x component of the acceleration vector with the associated confidence value.

* _yAcceleration_ of type [**AccelerationComponent**](ETSI-ITS-CDD.md#AccelerationComponent) <br>
...
* _laneNumber_ of type [**LanePosition**](ETSI-ITS-CDD.md#LanePosition) <br>
...
* _connectingLane_ of type [**LanePosition**](ETSI-ITS-CDD.md#LanePosition)  OPTIONAL<br>
...
>>>
NOTE:&emsp;this DF is kept for backwards compatibility reasons only. It is recommended to use the [**CauseCodeV2**](ETSI-ITS-CDD.md#CauseCodeV2) instead.
>>>
...
* _roadworks3_ of type [**RoadworksSubCauseCode**](ETSI-ITS-CDD.md#RoadworksSubCauseCode) <br>
...
* _dangerousGoodsType_ of type [**DangerousGoodsBasic**](ETSI-ITS-CDD.md#DangerousGoodsBasic) <br>
...
This DF represents a portion of digital map. It shall contain a list of waypoints [**ReferencePosition**](ETSI-ITS-CDD.md#ReferencePosition).
...
This DF shall contain  a list of waypoints [**ReferencePosition**](ETSI-ITS-CDD.md#ReferencePosition).
...
* _simplelanePosition_ of type [**LanePosition**](ETSI-ITS-CDD.md#LanePosition) <br>
...
>>>
NOTE:&emsp;this DF is kept for backwards compatibility reasons only. It is recommended to use [**AccelerationComponent**](ETSI-ITS-CDD.md#AccelerationComponent) instead.
>>>
...
* _lanePositionBased_ of type **SEQUENCE**  (SIZE(1..4)) OF LanePositionOptions<br>
  a set of up to `4` lanes that are partially or fully occupied by an object or event, ordered by increasing value of [**LanePosition**](ETSI-ITS-CDD.md#LanePosition). 
...
>>>
NOTE:&emsp;this DF is kept for backwards compatibility reasons only. It is recommended to use [**Path**](ETSI-ITS-CDD.md#Path) instead.
>>>
...
&nbsp;&nbsp;&nbsp;&nbsp;**Revision:** _created in V2.1.1 based on [**ReferencePosition**](ETSI-ITS-CDD.md#ReferencePosition) but using [**PositionConfidenceEllipse**](#PositionConfidenceEllipse)._
```asn1
...
This DF shall contain a list of [**StationType**](ETSI-ITS-CDD.md#StationType). to which a certain traffic restriction, e.g. the speed limit, applies.
...
This DF represents one or more paths using [**Path**](ETSI-ITS-CDD.md#Path).
...
* _trailerWidth_ of type [**VehicleWidth**](ETSI-ITS-CDD.md#VehicleWidth)  OPTIONAL<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;**Revision:** _created in V2.1.1 based on [**VehicleLength**](ETSI-ITS-CDD.md#VehicleLength) but using [**TrailerPresenceInformation**](#TrailerPresenceInformation)._
```asn1
...
This DF represents the status of the exterior light switches of a VRU.
 This DF is an extension of the vehicular DE [**ExteriorLights**](ETSI-ITS-CDD.md#ExteriorLights).

 It shall include the following components:

* _vehicular_ of type [**ExteriorLights**](ETSI-ITS-CDD.md#ExteriorLights) <br>
