...
## etsi_its_messages (noetic) - 3.0.0-1

The packages in the `etsi_its_messages` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -y --no-web --ros-distro noetic --override-release-repository-push-url https://github.com/ika-rwth-aachen/etsi_its_messages-release.git --no-pull-request --debug etsi_its_messages` on `Tue, 10 Dec 2024 09:12:19 -0000`
...
## etsi_its_messages (noetic) - 2.4.0-1

The packages in the `etsi_its_messages` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -y --no-web --ros-distro noetic --override-release-repository-push-url https://github.com/ika-rwth-aachen/etsi_its_messages-release.git --no-pull-request --debug etsi_its_messages` on `Tue, 19 Nov 2024 11:06:19 -0000`
...
## etsi_its_messages (noetic) - 2.3.0-1

The packages in the `etsi_its_messages` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -y --no-web --ros-distro noetic --override-release-repository-push-url https://github.com/ika-rwth-aachen/etsi_its_messages-release.git --no-pull-request --debug etsi_its_messages` on `Tue, 15 Oct 2024 15:57:33 -0000`
...
## etsi_its_messages (noetic) - 2.2.0-1

The packages in the `etsi_its_messages` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -y --no-web --ros-distro noetic --override-release-repository-push-url https://github.com/ika-rwth-aachen/etsi_its_messages-release.git --no-pull-request --debug etsi_its_messages` on `Thu, 01 Aug 2024 11:28:43 -0000`
...
## etsi_its_messages (noetic) - 2.1.0-3

The packages in the `etsi_its_messages` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release --rosdistro noetic --track noetic etsi_its_messages` on `Tue, 09 Jul 2024 17:28:31 -0000`
...
## etsi_its_messages (noetic) - 2.0.2-2

The packages in the `etsi_its_messages` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release --rosdistro noetic --track noetic etsi_its_messages` on `Mon, 03 Jun 2024 08:47:40 -0000`
